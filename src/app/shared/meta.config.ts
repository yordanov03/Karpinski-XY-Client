export const metaConfig = {
    ...
    paintingDetails: {
        title: 'Painting Details - Pawel Karpinski',
        description: 'Explore the details of Pawel Karpinski\'s unique paintings, including technique, dimensions, and year of creation. Discover the story behind each artwork.',
        keywords: 'painting details, Pawel Karpinski, abstract art, painting technique, art dimensions, Swiss artist, Zurich art, contemporary art, painting descriptions, art gallery, original paintings, artwork details, modern art, artistic process',
        ogImage: '', // Dynamically inserted
        ogUrl: '' // Dynamically inserted
    },
    ...
    exhibitionDetails: {
        title: 'Exhibition Details - Pawel Karpinski',
        description: 'Explore details of exhibitions featuring Pawel Karpinski, including dates, location, and organizer. Dive into the world of contemporary art and painting exhibitions.',
        keywords: 'exhibition details, Pawel Karpinski exhibitions, Swiss artist exhibitions, art events, exhibition dates, Zurich exhibitions, art locations, painting showcases, art gallery events, exhibition organizer, art details',
        ogImage: '', // Leave empty to dynamically populate with the first exhibition image
        ogUrl: '',   // Leave empty to dynamically populate with the current URL
    },
